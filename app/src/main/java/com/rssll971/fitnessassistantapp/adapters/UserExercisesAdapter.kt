...
/**
 * Adapter show all users exercises as a list
 * Required for StartWorkoutFragment and ExerciseCatalogFragment*/
class UserExercisesAdapter(private val context: Context,
    ...
    /**Save exercise ids, which were selected*/
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        with(holder){
            ...
            /**
             * Next statement responsible for correct text size and icon,
