...
class AddBmiUseCase @Inject constructor(private val repository: BmiRepository) {
    suspend operator fun invoke(param: BmiParam){
        repository.insertBmi(bmiParam = param)
    }
}