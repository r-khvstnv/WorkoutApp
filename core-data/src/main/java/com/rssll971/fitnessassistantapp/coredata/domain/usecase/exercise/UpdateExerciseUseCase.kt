...
class UpdateExerciseUseCase @Inject constructor(private val repository: ExerciseRepository) {
    suspend operator fun invoke(param: ExerciseParam) = repository.updateExercise(param)
}